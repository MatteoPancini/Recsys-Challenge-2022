if __name__ == "__main__":
    ...
    for index in range(len(URM_train_list)):
        ...
        recommender_RP3beta_list[index].fit(alpha=0.3146556397597279, beta=0.22537681115893407, topK=274)

        recommender_ItemKNN_list.append(ItemKNNCFRecommender(URM_train_list[index], verbose=False))
        recommender_ItemKNN_list[index].fit(topK=60, shrink=110)
    ...
    recommender_RP3beta.fit(alpha=0.3146556397597279, beta=0.22537681115893407, topK=274)

    recommender_ItemKNN = ItemKNNCFRecommender(URM_train_init, verbose=False)
    recommender_ItemKNN.fit(topK=60, shrink=110)
    ...
    with open("logs/" + "RP3beta_ItemKNNCF10" + "_logs_" + datetime.now().strftime(
