if __name__ == "__main__":
    ...
    for index in range(len(URM_train_list)):
        ...
        recommender_RP3beta_list[index].fit(alpha=0.7797119898657642, beta=0.294098959281335, topK=184)

        recommender_ItemKNN_list.append(ItemKNNCFRecommender(URM_train_list[index], verbose=False))
        recommender_ItemKNN_list[index].fit(topK=356, shrink=115)
    ...
    with open("logs/" + "RP3beta_ItemKNNCF20" + "_logs_" + datetime.now().strftime(
