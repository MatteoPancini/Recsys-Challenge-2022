if __name__ == '__main__':
    ...
    partialsFile = 'UserRP3beta_' + datetime.now().strftime('%b%d_%H-%M-%S')
    ...
    def objective(trial):
        ...
        resultsToPrint = [recommender_UserRP3beta_list[0].RECOMMENDER_NAME, alpha, beta, topK,  sum(MAP_result) / len(MAP_result)]
