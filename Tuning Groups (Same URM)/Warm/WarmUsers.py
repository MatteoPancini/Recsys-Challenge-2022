if __name__ == "__main__":
    ...
    oldRP3.fit(alpha=0.572121247163269, beta=0.3107107930844788, topK=92)
    ...
    oldSlim.fit(topK=185, alpha=0.06551072224428456, l1_ratio=0.032574129361384)
    ...
    bestSlim.fit(topK=258, alpha=0.035237980092119314, l1_ratio=0.05512644878845981)
    ...
    bestRP3.fit(alpha=0.7849910963981444, beta=0.3219406144420833, topK=64)
