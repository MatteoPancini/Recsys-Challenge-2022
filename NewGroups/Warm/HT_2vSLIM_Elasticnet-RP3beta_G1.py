if __name__ == '__main__':
    ...
    for index in range(len(URM_train_list)):
        ...
        recommender_SlimElasticnet_list[index].fit(topK=100, alpha=0.010975001075569505, l1_ratio=0.48011657798419954)
    ...
    recommender_Slim_Elasticnet.fit(topK=100, alpha=0.010975001075569505, l1_ratio=0.48011657798419954)
