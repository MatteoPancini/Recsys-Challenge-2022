if __name__ == "__main__":
    ...
    for i in range(1):
        ...
        recommender_ItemKNN_list.append(ItemKNNCFRecommender(URM_train=URM_train_list[i]))
        recommender_ItemKNN_list[i].fit(topK=183, shrink=584, similarity="cosine", feature_weighting="TF-IDF")
    ...
    def objective(trial):
        ...
        for i in range(1):
            recommender_hybrid_list.append(LinearHybridTwoRecommenderTwoVariables(URM_train_list[i],
                                                                                  ...
                                                                                  Recommender_2=recommender_ItemKNN_list[i]))
    ...
    rec2.fit(topK=183, shrink=584, similarity="cosine", feature_weighting="TF-IDF")
    ...
    with open("logs/" + "Slim-RP3beta-ItemKNN" + "_logs_" + datetime.now().strftime(
