if __name__ == '__main__':
    ...
    UserKNN_init = UserKNNCFRecommender(URM)
    ...
    recommender_Hybrid1 = LinearHybridTwoRecommenderTwoVariables(URM, Recommender_1=hybrid2_init,
                                                                Recommender_2=ItemKNN_init)
    recommender_Hybrid1.fit(alpha=0.5182132379810547, beta=4.19321787406275e-06)

    recommender_Hybrid = LinearHybridTwoRecommenderTwoVariables(URM, Recommender_1=recommender_Hybrid1, Recommender_2=UserKNN_init)
    recommender_Hybrid.fit(alpha=0.8694899626448637, beta=0.0001357127058291026)

    # Write the submission file
    write_submission(recommender=recommender_Hybrid,
                     target_users_path="../../Input/data_target_users_test.csv",
                     out_path='../../Output/{}_submission.csv'.format('UserKNNItemKNNIALSSlimRP3_0901'))