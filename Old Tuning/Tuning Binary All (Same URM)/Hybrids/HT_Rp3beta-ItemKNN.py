if __name__ == "__main__":
    ...
    partialsFile = 'RP3beta-ItemKNN_' + datetime.now().strftime('%b%d_%H-%M-%S')
    ...
    for i in range(len(URM_train_list)):
        ...
        recommender_P3alpha_list.append(ItemKNNCFRecommender(URM_train=URM_train_list[i]))
        recommender_P3alpha_list[i].fit(ICM=ICM, shrink=919, topK=584, similarity='dice', normalization='bm25')
    ...
    with open("logs/" + "RP3beta-ItemKNN_" + "_logs_" + datetime.now().strftime(
