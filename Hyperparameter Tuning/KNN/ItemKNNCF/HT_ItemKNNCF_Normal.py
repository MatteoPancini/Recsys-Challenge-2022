if __name__ == '__main__':
    ...
    partialsFile = 'ItemKNNCF_Normal_' + datetime.now().strftime('%b%d_%H-%M-%S')
    ...
    with open("logs/" + recommender_ItemKNNCF.RECOMMENDER_NAME + "_Normal" + "_logs_" + datetime.now().strftime(
