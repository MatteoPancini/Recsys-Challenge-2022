if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        feature_weighting = trial.suggest_categorical("feature_weighting", ["bm25", "tfidf", "bm25plus"])
        ...
        for index in range(len(URM_train_list)):
            ...
            recommender_ItemKNNCF_list[index].fit(ICM=ICM*ICMweight, shrink=shrink, topK=topK, similarity=similarity,
                                                  feature_weighting=feature_weighting, normalization=normalization)
    ...
    recommender_ItemKNNCF.fit(ICM=ICM*ICMweight, shrink=shrink, topK=topK, similarity=similarity,
                                                  feature_weighting=feature_weighting, normalization=normalization)
