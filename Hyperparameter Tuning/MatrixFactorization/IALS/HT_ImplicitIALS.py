if __name__ == '__main__':
    ...
    def objective(trial):
        ...
        n_factors = trial.suggest_int("n_factors", 100, 500)
        ...
        for index in range(len(URM_train_list)):
            recommenders_IALS_list.append(ImplicitALSRecommender(URM_train=URM_train_list[index], verbose=False))
    ...
    recommender_IALS.fit(factors=n_factors, regularization=regularization, alpha=alpha, iterations=10)
