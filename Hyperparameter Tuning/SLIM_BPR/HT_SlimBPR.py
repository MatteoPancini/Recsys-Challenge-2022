if __name__ == "__main__":
    ...
    def objective(trial):
        ...
        for index in range(len(URM_train_list)):
            ...
            recommender_SlimBPR_list[index].fit(topK=topK, epochs=epochs,
                                                lambda_j=lambda_j, lambda_i=lambda_i)
    ...
    recommender_SlimBPR = SLIM_BPR_Cython(URM_train=URM_train, verbose=False)

    recommender_SlimBPR.fit(topK=topK, epochs=epochs,
                                                lambda_j=lambda_j, lambda_i=lambda_i)
