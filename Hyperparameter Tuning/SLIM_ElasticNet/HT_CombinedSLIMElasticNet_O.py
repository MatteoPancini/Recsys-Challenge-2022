if __name__ == "__main__":
    ...
    from Utils.recsys2022DataReader import createBigBumpURM, createBigICM
    ...
    for URM in URM_train_list:
        ICMs_combined.append(sps.vstack([URM, ICM.T]))
    ...
    def objective(trial):
        ...
        for index in range(len(URM_train_list)):
            ...
            recommender_SlimElasticnet_list.append(MultiThreadSLIM_SLIMElasticNetRecommender(ICMs_combined[index]))
