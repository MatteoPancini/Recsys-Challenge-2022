if __name__ == "__main__":
    ...
    for i in range(len(URM_train_list)):
        ...
        recommender_ItemKNN_list[i].fit(ICM=ICM, shrink=189, topK=352, similarity='asym', normalization='bm25')
    ...
    rec2.fit(ICM=ICM, shrink=189, topK=352, similarity='asym', normalization='bm25')
